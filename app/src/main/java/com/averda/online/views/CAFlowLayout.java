...
public class CAFlowLayout extends ViewGroup {
    ...
    public CAFlowLayout(Context context) {
        super(context);

        this.readStyleParameters(context, null);
    }

    public CAFlowLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        this.readStyleParameters(context, attributeSet);
    }

    public CAFlowLayout(Context context, AttributeSet attributeSet, int defStyle) {
