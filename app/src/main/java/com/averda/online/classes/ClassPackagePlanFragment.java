...
public class ClassPackagePlanFragment extends Fragment {
    RecyclerView mRecyclerView;
    private GridLayoutManager mLayoutManager;
    private ClassSeriesAdapter adapter = null;
    private HashMap<Integer, JSONArray> listData = new HashMap<>();
    public ArrayList<Integer>courseIds = new ArrayList<>();

    public ClassPackagePlanFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ServerApi.callServerApi(getActivity(), ServerApi.BASE_URL,"OnlineClassPackages/0", null, new ServerApi.CompleteListener() {
            @Override
            public void response(JSONObject response) {
                ...
                Utils.saveObject(getActivity(), data.toString(), "OnlineClassPackages_0");
                setList(data);
            }
    ...
    private void setList(JSONArray data){
        if (data != null) {
            ...
            if(adapter == null) {
                ...
                adapter = new ClassSeriesAdapter(listData.get(-1),R.layout.test_plan_item,getActivity());
            ...
            ((ClassPackagePlanActivity)getActivity()).setFilterOptions();
        }
    }
    private void checkCacheValues(){
        ...
        try{
            ...
            value = (String)Utils.getObject(getActivity(), "OnlineClassPackages_0");
