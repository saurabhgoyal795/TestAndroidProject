...
public class FrreCourseClassPackagePlanFragment extends Fragment {
    RecyclerView mRecyclerView;
    private GridLayoutManager mLayoutManager;
    private FreeCourseClassSeriesAdapter adapter = null;
    private HashMap<Integer, JSONArray> listData = new HashMap<>();
    public ArrayList<Integer>courseIds = new ArrayList<>();

    public FrreCourseClassPackagePlanFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ServerApi.callServerApi(getActivity(), ServerApi.BASE_URL,"FreeOnlineClassPackages/0", null, new ServerApi.CompleteListener() {
            @Override
            public void response(JSONObject response) {
                ...
                Utils.saveObject(getActivity(), data.toString(), "FreeOnlineClassPackages_0");
                setList(data);
            }
    ...
    private void setList(JSONArray data){
        if (data != null && data.length() > 0) {
            ...
            if(adapter == null) {
                ...
                adapter = new FreeCourseClassSeriesAdapter(listData.get(-1),R.layout.test_plan_item,getActivity());
    ...
    private void checkCacheValues(){
        ...
        try{
            ...
            value = (String)Utils.getObject(getActivity(), "FreeOnlineClassPackages_0");
